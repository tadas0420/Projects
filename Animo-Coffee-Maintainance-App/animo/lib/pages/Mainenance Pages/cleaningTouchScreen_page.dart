...
class CleaningTouchScreenPage extends StatefulWidget {
  @override
  _CleaningTouchScreenPageState createState() =>
      _CleaningTouchScreenPageState();
}

class _CleaningTouchScreenPageState extends State<CleaningTouchScreenPage> {
  int currentPageIndex = 0;
  String pageTitle = "Cleaning the touchscreen";
